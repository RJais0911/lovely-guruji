...
function termsandcondition() {
  return (
    <Layout>
      <div className="max-w-7xl bg-[#fcfcfc] dark:bg-[#171717] mx-auto my-10 p-10 h-screen">
        <h1 className="dark:text-white font-ubuntu text-black text-3xl my-10">
          Terms and condtions
        </h1>
        ...
        <span className="dark:text-gray-400 font-ubuntu text-gray-600 lg:hover:underline">
