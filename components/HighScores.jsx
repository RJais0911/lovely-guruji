    ...
    <div>
      <div className="flex flex-col justify-center h-[90vh]">
        <div className="lg:w-6/12 w-10/12 mx-auto px-10 py-16 outline outline-slate-300 outline-2 rounded-3xl shadow-xl">
          ...
          <button
            className="bg-skin-main text-white px-3 py-3 rounded-lg lg:hover:bg-green-900 transition-all shadow-md mr-5 mb-3"
            onClick={() => {
              handleState("start");
            }}
          >
          ...
          <button
            className="bg-skin-main text-white px-3 py-3 rounded-lg lg:hover:bg-green-900 transition-all shadow-md"
            onClick={() => {
              hadleClearHighScore();
            }}
          >
