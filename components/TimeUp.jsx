  ...
  return (
    <div className="flex flex-col justify-center h-[90vh]">
      <div className="lg:w-6/12 w-10/12 mx-auto px-10 py-16 outline outline-slate-300 outline-2 rounded-3xl shadow-xl">
        <h1 className="font-black font-Inter mb-6 drop-shadow-sm">Time Up!</h1>
        ...
        <button
          className="text-black dark:text-white px-3 py-3 rounded-lg lg:hover:bg-gray-100 transition-all shadow-md"
          onClick={() => {
            handleState("done");
          }}
        >
